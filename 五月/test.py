...
class InceptionV1Module(nn.Module):
    def __init__(self, in_channels, out_channels1, out_channels2reduce, out_channels2, out_channels3reduce,
        ...
        self.branch1_conv = ConvBNReLU(in_channels, out_channels1, kernel_size=1)
        ...
        self.branch4_conv1 = ConvBNReLU(in_channels, out_channels4, kernel_size=1)
    ...
    def forward(self, x):
        ...
        out = t.cat([out1, out2, out3, out4], dim=1)
        return out
